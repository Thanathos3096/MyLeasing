...
namespace MyLeasing.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            ...
            {
                var user = await CreateUserAync(model);
                if(User!=null)
                {
                    var owner = new Owner
                    {
                ...
                ModelState.TryAddModelError(string.Empty, "User with this email already exist");
            }
            return View(model);
        }

        private async Task<User> CreateUserAync(AddUserViewModel model)
        {
            var user = new User
            {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Owner cant be delete because it has properties.");
                return RedirectToAction(nameof(Index)); ;
            }
